/**
 * ⚖️ TESTES DO USERSERVICE COM INVERSIFYJS
 * 
 * Este arquivo demonstra como testar o UserService com decoradores.
 */

import { UserService } from '../Services/UserService.js';

describe('UserService (InversifyJS)', () => {
  ...
  // ✅ VANTAGEM: Testes de decoradores
  describe('decoradores InversifyJS', () => {
    it('deve ter decorador @injectable', () => {
      // ✅ VANTAGEM: Podemos verificar se a classe tem os decoradores necessários
      // Note: Em runtime, os decoradores são aplicados
