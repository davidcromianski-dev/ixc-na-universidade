 ...
 * 
 * Este arquivo demonstra como o UserService pode ser testado
 * de forma isolada e controlada.
 */

import { UserService } from '../Services/UserService.js';

describe('UserService (Código Melhorado)', () => {
  ...
  describe('verifyPassword', () => {
    ...
    it('deve retornar false para senhas com espaços em branco', () => {
      const result = userService.verifyPassword('  ', 'password123');
      expect(result).toBe(false);
    });
  });
